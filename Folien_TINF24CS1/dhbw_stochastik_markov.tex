...
Durch \textbf{Detailed Balance} (Symmetrie des Mischens):
\[
\pi(\sigma) = \frac{1}{n!} \quad \text{für alle } \sigma \in S_n
\]
Die Gleichverteilung ist die eindeutige invariante Verteilung.
\end{block}
\begin{block}{Konvergenz}
Nach genügend vielen Mischvorgängen ist das Deck ``gut gemischt''\\(nahe an Gleichverteilung). Für Top-to-Random: $\approx n \ln n$ Schritte.
\end{block}
 \end{frame}
