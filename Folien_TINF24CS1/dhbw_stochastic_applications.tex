...
Es gibt drei Tueren. Hinter genau einer steht das Auto, hinter den beiden anderen je eine Ziege.
Der Spieler waehlt zunaechst irgendeine der drei Tueren.
Danach oeffnet der Moderator, der die Lage des Autos kennt, immer eine andere Tuer mit Ziege.
Anschliessend darf der Spieler zur einzig verbleibenden geschlossenen Tuer wechseln.
\end{block}
...
\end{align*}
Da genau eine von drei Tueren das Auto enthaelt, gilt sofort
\begin{align*}
P(A)=\frac13.
\end{align*}
\end{block}
...
Im Fall \(A^c\) ist die erste Wahl falsch; der Moderator muss dann die einzige Ziegentuer unter den beiden anderen oeffnen, und die verbleibende geschlossene Tuer enthaelt das Auto.
\end{block}
...
P(A)=\frac13.
\end{align*}
Also ist Wechseln optimal. Die genaue Auswahlregel des Moderators unter mehreren moeglichen Ziegentueren ist dabei egal, solange er immer eine Ziegentuer oeffnet und Wechseln anbietet.
\end{block}
...
Wichtig: $P(D \mid H)$ und $P(D \mid H^c)$ sind keine Gegenwahrscheinlichkeiten, weil unterschiedlich konditioniert wird. Komplementaer waeren hier zum Beispiel $P(D \mid H)$ und $P(D^c \mid H)$.
\end{block}
