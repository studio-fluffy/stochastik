...
\begin{block}{Praktische Konsequenz}
Ein bayesianisches Intervall beschreibt Plausibilität nach den Daten.
Ein frequentistisches Konfidenzintervall ist ein Verfahren mit kontrollierter Trefferquote.
Es bedeutet also nicht direkt: ``Der Parameter liegt mit Wahrscheinlichkeit $95\%$ darin.''
\end{block}
