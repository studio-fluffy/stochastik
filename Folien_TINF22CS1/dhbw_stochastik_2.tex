...
Ein diskreter Wahrscheinlichkeitsraum ist ein Wahrscheinlichkeitsraum $(\Omega, \mathcal{A}, P)$, bei dem die Grundmenge $\Omega$ abzählbar.
\end{block}
\begin{block}{Beispiel: Laplace Experiment}
...
\begin{block}{Lemma}
Sei $(\Omega, \mathcal{A}, P)$ ein  Wahrscheinlichkeitsraum. Dann ist für $A \in \mathcal{A}$ 
\begin{align*}
& P(A^c) = 1 - P(A) \\
& P(\emptyset) = 0
\end{align*}
