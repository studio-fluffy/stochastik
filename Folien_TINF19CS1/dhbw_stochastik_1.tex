...
Kausalität (von lateinisch causa, Ursache, und causalis,  ursächlich, kausal) ist die Beziehung zwischen Ursache und Wirkung. Sie betrifft die Abfolge von Ereignissen und Zuständen, die aufeinander bezogen sind. Demnach ist A die Ursache für die Wirkung B, wenn B von A herbeigeführt
\end{block}
...
\begin{figure}[htp]
      \centering
    \includegraphics[width=0.3\textwidth]{img/Paris}
