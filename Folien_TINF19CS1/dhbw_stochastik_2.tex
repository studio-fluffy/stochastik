...
\begin{block}{Interpretation}
Die Grundmenge wird durch das betrachtete Experiment definiert. Die Menge der Ergebnisse  $\mathcal{A}$ beschreibt die Fragestellungen, an denen wir im Rahmen des Experiments interessiert sind.
...
Ein diskreter Wahrscheinlichkeitsraum ist ein Wahrscheinlichkeitsraum $(\Omega, \mathcal{A}, P)$, bei dem die Grundmenge $\Omega$ abzählbar ist.
\end{block}
